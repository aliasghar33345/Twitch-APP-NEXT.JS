...
import {rec_channel,top_channel} from '../data/mock-data'
           ...
           rec_channel.map((item,index)=>(
            <div key={index} className='inline-flex items-center w-full py-[2px]'>
                ...
                <div className='hidden xl:flex justify-between w-full'>
                    ...
                    <p className='flex'><BsDot size={20} color='red' />{item.rank}K</p>
                </div>
            </div>
           ))
